...
Question
Answer
What process was observed during the investigation?
svchost.exe
Which registry key was modified?
HKLM\System\CurrentControlSet\Enum\WpdBusEnumRoot
Which device was accessed using RawAccessRead?
\Device\HarddiskVolume3
What was the suspected initial access vector?
USB Storage Device (Removable Media)
